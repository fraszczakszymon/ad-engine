...
const test = {
	resolve: {
		alias: {
			'@wikia/ad-engine': path.join(__dirname, 'ad-engine'),
			'@wikia/ad-bidders': path.join(__dirname, 'ad-bidders'),
			'@wikia/ad-products': path.join(__dirname, 'ad-products'),
			'@wikia/ad-services': path.join(__dirname, 'ad-services'),
		},
	},
};
