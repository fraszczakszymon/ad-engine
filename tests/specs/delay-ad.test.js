...
describe('It will test delay ad page top leaderboard', () => {
	beforeEach(() => {
	...
	it('will test if top leaderboard shows up after clicking the button and if it was viewed', () => {
...
describe('It will test delay ad page top boxad', () => {
	beforeEach(() => {
		browser.url(delayAd.pageLink);
		browser.waitForVisible(delayAd.loadAdsButton, timeouts.standard);
	});
